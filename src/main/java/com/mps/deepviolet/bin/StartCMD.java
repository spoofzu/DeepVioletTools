...
public class StartCMD {
	...
	private void init(String[] args) {
		...
		try {
			...
			// TODO: Java8 java
			// -Djdk.tls.client.protocols="TLSv1,TLSv1.1,TLSv1.2" enable/disable
			// protocols to test
			...
			options.addOption("s", "sections", true,
					"Optional, unspecified prints all sections or specify sections. [t|h|r|c|i|s|n]");
			...
			if (cmdline.hasOption("h")) {
				...
				hm.append("java -jar dvCMD.jar -serverurl <host|ip> [-wc <file> | -rc <file>] [-h -s{t|h|r|c|i|s|n}]"
						+ EOL);
